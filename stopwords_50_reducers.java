...
public class stopwords_50_reducers_no_combiners extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		int res = ToolRunner.run(new Configuration(),
				new stopwords_50_reducers_no_combiners(), args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		...
		System.out.println(Arrays.toString(args));
		Job job = new Job(getConf(), "stopwords_50_reducers_no_combiners");
		// Initializing the key/values, mapper/reducer and the input/ouput format
		job.setJarByClass(stopwords_50_reducers_no_combiners.class);
