...
public class stopwords_10_reducers_with_combiners extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		int res = ToolRunner.run(new Configuration(),
				new stopwords_10_reducers_with_combiners(), args);
		System.exit(res);
	}
	...
	public int run(String[] args) throws Exception {
		...
		System.out.println(Arrays.toString(args));
		Job job = new Job(getConf(), "stopwords_10_reducers_with_combiners");
		// Initializing the key/values, mapper/reducer and the input/ouput format
		job.setJarByClass(stopwords_10_reducers_with_combiners.class);
