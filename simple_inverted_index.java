...
public class inverted_index_simple extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		int res = ToolRunner.run(new Configuration(),
				new inverted_index_simple(), args);
	...
	public int run(String[] args) throws Exception {
		...
		System.out.println(Arrays.toString(args));
		Job job = new Job(getConf(), "inverted_index_simple");
		// Initializing the key/values, mapper/reducer and the input/ouput format
		job.setJarByClass(inverted_index_simple.class);
